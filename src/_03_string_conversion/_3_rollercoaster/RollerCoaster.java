...
public class RollerCoaster {
	...
	// 1) Make a main method that includes all the steps below…. 
		public static void main(String[] args) {
			String hightToRide = JOptionPane.showInputDialog("what is your hight in inches"); 
			int hightToRide2 = Integer.parseInt(hightToRide);
			if( hightToRide2 >= 48 ) { 
				JOptionPane.showMessageDialog(null, "Hurray! You are tall enough to ride the coaster alone!");
			}else if (hightToRide2 >= 42 && hightToRide2 < 48){ 
				JOptionPane.showMessageDialog (null, "You can ride the coaster with someone else!");
			}else if (hightToRide2 < 42){
