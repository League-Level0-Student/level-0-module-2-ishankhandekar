...
public class StringsCannotAdd {
	...
	public static void main(String[] args) {
		...
		int fiveasstringn = 0;
		int sixasstringn = 0;
		fourAsString = JOptionPane.showInputDialog("enter 4");
		SixAsString = JOptionPane.showInputDialog("enter 6");
		JOptionPane.showMessageDialog(null, fourAsString + SixAsString);
		FiveAsString = JOptionPane.showInputDialog("enter 5");
		JOptionPane.showMessageDialog(null, fourAsString + SixAsString + FiveAsString);
		fourAsStringn = Integer.parseInt(fourAsString);
		sixasstringn = Integer.parseInt(SixAsString);
		fiveasstringn = Integer.parseInt(FiveAsString);
		JOptionPane.showMessageDialog(null, fourAsStringn + sixasstringn + fiveasstringn);
	}
